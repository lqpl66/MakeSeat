...
/**
 * 
* @Description:  RegexUtil.match(RegexUtil.XXX,string);
*
 */
public class RegexUtil {
	// 常见 正则表达式 开始   RegexUtil.match(RegexUtil.IsIntNumber,"str")
	/**  匹配正数   */
	public static final String plusNumber = "^[+]{0,1}(\\d+)$|^[+]{0,1}(\\d+\\.\\d+)$";
	/**  匹配正整数   */
	public static final String IsIntNumber = "^[0-9]*[1-9][0-9]*$";
	/** 非负正整数 （正整数+0）*/
	public static final String npIntNumber = "^\\d+$"; 
	/** 负整数 */
	public static final String negativePositiveIntNumber = "^-[0-9]*[1-9][0-9]*$"; 
	/** 非正整数 （负整数+0）*/
	public static final String nonPositiveInteger = "^((-\\d+) ?(0+))$"; 
	/** 非负数*/
	public static final String nonnegativeNumber="^\\d+(\\.{0,1}\\d+){0,1}$";
    /** 邮箱 */
	public static final String SIMPLE_MAIL_CHECK ="^[a-zA-Z0-9_-]+@[a-zA-Z0-9_-]+(\\.[a-zA-Z0-9_-]+)+$";
  ...
  public static void main(String[] args) {
	System.out.println(match(plusNumber,"-9"));
}   
